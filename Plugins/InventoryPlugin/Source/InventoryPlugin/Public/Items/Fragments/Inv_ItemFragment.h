...
struct FInv_ConsumeModifier : public FInv_LabeledNumberFragment
{
	...
	virtual void OnConsume(APlayerController* PlayerCont, int32 Count) {}
};
...
{
	GENERATED_BODY()
	virtual void OnConsume(APlayerController* PC, int32 Count);
	virtual void Assimilate(UInv_CompositeBase* Composite) const override;
	virtual void Manifest() override;
private:
...
struct FInv_HealthPotionFragment : public FInv_ConsumeModifier
{
	...
	virtual void OnConsume(APlayerController* PlayerCont, int32 Count) override;
};
